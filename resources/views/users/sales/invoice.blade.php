...
@section('user_content')
                ...
                <div class="table-responsive">
                    <table class="table"  width="100%" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <th colspan="2"></th>
                            <th class="text-right">Total:</th>
                            <th class="text-right">{{$totalPaid = $invoice->items->sum('total') }}</th>
                            <th></th>
                        </tr>
                        <tr>
                            <th><button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#newReceiptForInvoice"><i class="fa fa-plus"></i> Add Receipt</button></th>
                            <th colspan="2"></th>
                            <th class="text-right">Total:</th>
                            <th class="text-right">{{$totalPayable = $invoice->recepits()->sum('amount') }}</th>
                            <th></th>
                        </tr>
                        <tr>
                            <th colspan="3"></th>
    ...
    <div class="modal fade" id="newReceiptForInvoice" tabindex="-1" aria-labelledby="newReceiptForInvoiceModalLabel" aria-hidden="true">
    ...
    <div class="modal fade" id="newProduct" tabindex="-1" aria-labelledby="newProductModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                {!! Form::open(['route' => ['user.sales.invoice.add_item', ['id' => $user->id , 'invoice_id' => $invoice->id ]], 'method' => 'post']) !!}
                <div class="modal-header">
